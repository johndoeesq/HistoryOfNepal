...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    mysqli_query($conn, "INSERT INTO description_content(images,title,description,category) VALUES('$file_name','$title','$description','$category')");

    header("Refresh:0; url=Description.php");
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li ><a href="../forms/Homepage.php"><i class="fa fa-circle-o"></i><span>HomePage</span></a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form"  method="post" enctype="multipart/form-data" action="Describe_add.php">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control"  name="title" id="exampleInputTitle" >
                </div>

                  <div class="form-group">
                  <label for="exampleInputDes">Description</label>
                  <input class="form-control"  name="description" id="exampleInputDes">
                </div>
                <div>
 <div class="form-group">
