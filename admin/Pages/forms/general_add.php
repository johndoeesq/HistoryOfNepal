...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $category = $_POST['category'];
        ...
        mysqli_query($conn, "INSERT INTO image_content(images, category) VALUES('$file_name','$category')");
...
?>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <form role="form"  method="post" enctype="multipart/form-data" action="general_add.php">
              <div class="box-body">
