...
$sql="select images from image_content WHERE category='politics'";
$sql1="select * from description_content WHERE category='politics'";
                    ...
                    <div class="about-carousel">
                        <div class="owl-carousel" id="owl-carousels">
                            ...
                            while ($row=mysqli_fetch_array($image_content_result)) {
                                echo '<div ><img src = "images/Politics/'.$row['images']. '" alt = "" style = "height:197px" ></div >';
                            }
                            ?>
                        </div>
                    </div>
                        ...
                        <div id="container">
                            ...
                            <div class="element post-transition lakes">
                                <div class="example example-cover" >
                                    <div id="myImg">
                                        <img  data-toggle="modal"  src="images/Politics/'.$row['images'].'"  alt="Snow" onclick="check('.$row['id'].')">
                                    </div>
                                    <!-- Modal -->
