...
$sql="select images from image_content WHERE category='miscelleneous'";
$sql1="select * from description_content WHERE category='miscelleneous'";
                        ...
                        <div class="container">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li class="active" ><a href="mis.php">Miscelleneous</a></li>
                                </ul>
                            </div>
                            <!-- /.navbar-collapse -->
                        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li><a href="index.php">Home</a></li>
                    <li class="active">Miscellenous</li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <div class="about-carousel">
                        <div class="owl-carousel" id="owl-carousels">
                            ...
                            while ($row=mysqli_fetch_array($image_content_result)) {
                                echo '<div ><img src = "images/Miscellenous/'.$row['images']. '" alt = "" style = "height:197px" ></div >';
                            }
                            ?>
    ...
    echo '
                            ...
                            <div class="element post-transition lakes">
                                <div class="example example-cover">
                                    <div id="myImg">
                                        <img data-toggle="modal"  src="images/Miscellenous/'.$row['images'].'"  alt="Snow"  onclick="check('.$row['id'].')">
                                    </div>
                                    <!-- Modal -->
