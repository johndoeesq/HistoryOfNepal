...
$sql="select images from image_content WHERE category='monuments'";
$sql1="select * from description_content WHERE category='monuments'";
                       ...
                       <div class="container">
                           ...
                           <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                               <ul class="nav navbar-nav navbar-right">
                                   ...
                                   <li class="active"><a href="monuments.php">Monuments</a></li>
...
while ($row=mysqli_fetch_array($image_content_result)) {
    echo '<div ><img src = "images/Monuments/'.$row['images']. '" alt = "" style = "height:197px" ></div >';
    }
?>
                        ...
                        <div id="container">
                            ...
                            <div class="element post-transition lakes">
                                <div class="example example-cover" >
                                    <div id="myImg">
                                    <img  data-toggle="modal"  src="images/Monuments/'.$row['images'].'"  alt="Snow" onclick="check('.$row['id'].')">
                                     </div>
                                    <!-- Modal -->
