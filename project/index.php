                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="about-info-asia">
                              ...
                              <p style="text-align:justify"> '.$row['description2'].'</p>
                                </div>
                        </div>


              <div class="col-md-4">
    <img src="admin/Pages/forms/image1/'.$row['image'].'" alt=""  style ="width:400px" align="right"/>
    <img src="admin/Pages/forms/image2/'.$row['image2'].'" alt=""   style ="width:400px" align="right" />
